...
final class AuthenticationMiddleware extends Middleware implements InterfaceMiddleware {
    ...
    public function process(Request $request, Response $response): void {
        ...
        //if (($request->getController() != "authentication" && $request->getAction() != "resetPass") || ($request->getController() != "authentication" && $request->getAction() != "reset") || ($request->getController() != "user" && $request->getAction() != "resetByMail")) {
            session_start();
