        ...
        <table id="table_clientes" class="tabla">
            ...
            <tbody>
                ...
                foreach($result as $item => $value){
                    ...
                    echo "<tr class='fila'><td class='col1'>".$value["numero_venta"]."</td>";
                    echo "<td class='col2'>".$value["cliente"]."</td>";
                    echo "<td class='col3'>".$value["fecha"]."</td>";
                    echo "<td class='col4'>".$value["forma_pago"]."</td>";
                    echo "<td class='col5'>".$value["codigo_producto"]."</td>";
                    echo "<td class='col6'>".$value["cantidad"]."</td>";
                    echo "<td class='col6'>$ ".$value["precio_unitario"]."</td>";
                    echo "<td class='col6'>$ ".$value["total"]."</td>";
                    echo "</tr>";
                }
                ?>
            </tbody>
