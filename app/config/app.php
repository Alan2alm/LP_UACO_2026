...
const APP_URL = 'http://localhost/lab_prog_2026_Alan_Almonacid/public/';
define('APP_URI', $_SERVER['DOCUMENT_ROOT'] . '/lab_prog_2026_Alan_Almonacid/app/');
...
define('APP_DIR_IMGS',     APP_URI . 'libs/imgs/');
define('APP_DIR_VENDOR',     APP_URI . 'vendor/');

define('APP_FILE_TEMPLATE',     APP_DIR_TEMPLATE . 'template.php');
define('APP_PDF_GENERATE',     APP_DIR_TEMPLATE . 'generatePDF.php');
define('APP_FILE_LOG_ERRORS',   APP_URI.'logs/error.log');
define('APP_FILE_LOG_ACCESS',   APP_URI.'logs/access.log');
define('APP_FILE_LOGO',     APP_DIR_IMGS . 'logo-proyecto.png');
define('APP_FILE_AUTOLOAD',     APP_DIR_VENDOR . 'autoload.php');
